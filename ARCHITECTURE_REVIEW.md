...
**تنبيه بخصوص البحث**: نظراً لمحدودية Firestore في البحث النصي المتقدم، تم اعتماد البحث بـ "البادئة" (Prefix Search) لأرقام الفواتير. للبحث المتقدم بأسماء العملاء عبر آلاف السجلات، يوصى مستقبلاً باستخدام خدمة **Algolia** أو **ElasticSearch** لضمان سرعة البحث ودقته دون التأثير على أداء قاعدة البيانات.
