...
import com.batterysales.viewmodel.ProductLedgerItem
...
@Composable
fun LedgerItemCard(item: ProductLedgerItem) {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                InfoColumnLedger(label = "سعر تكلفة القطعة", value = formatPrice(entry.costPrice))
                InfoColumnLedger(label = " إجمالي الأمبيرات", value = formatPrice(entry.totalCost))
            }
